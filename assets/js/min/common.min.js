...
/***/function (module, exports, __webpack_require__) {
	...
	// main variables
	var _searchWrap = document.querySelector('.search-container'); // storing main div variable so it's not gonna search for entire body
	var _searchInput = _searchWrap.querySelector('.search-input'); // input to be cleared
	var _searchIcon = _searchWrap.querySelector('.clear-search-input'); // icon to click to remove childs
	var _searchList = _searchWrap.querySelector('.search-results-list'); // parent node where to remove childs
