...
(function ($) {
  document.addEventListener('DOMContentLoaded', function () {
    ...
    var tags = ["article", "video", "audio", "aside", "footer", "header", "main", "nav", "section", "time"];
...
var requestDataSearchInput = function requestDataSearchInput(data) {
    ...
    function c(c, e) {
      ...
      var c = [].slice.call(arguments, 1);return function () {
        ...
        var c, d;c = this.input.$input || a("<div>"), d = this.menu.$node || a("<div>"), c.on("blur.tt", function (a) {
          var e, f, g;e = document.activeElement, f = d.is(e), g = d.has(e).length > 0, b.isMsie() && (f || g) && (a.preventDefault(), a.stopImmediatePropagation(), b.defer(function () {
            c.focus();
          }));
